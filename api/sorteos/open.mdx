...
For reopening sorteos from other states, use:

<Card title="Force Open" icon="door-open" href="/api/sorteos/force-open">
  Forcefully open a sorteo from any non-evaluated state
</Card>

## Alternative: Activate and Open

To activate and open in a single operation:

<Card title="Activate and Open" icon="bolt" href="/api/sorteos/activate-and-open">
  Reactivate an inactive sorteo and open it immediately
</Card>
